...
# Глобальные шрифты для оптимизации
...
class Ball:
    ...
    def draw_score(self, screen):
        draw_text(str(self.score_left), FONT_SCORE, GREEN, screen, WIDTH // 4, 20)
        draw_text(str(self.score_right), FONT_SCORE, GREEN, screen, 3 * WIDTH // 4, 20)
