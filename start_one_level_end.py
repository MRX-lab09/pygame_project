...
def show_start_screen():
    screen.fill(BLACK)
    draw_text("Пинг-Понг", pygame.font.Font(None, 74), (255, 0, 0), screen, WIDTH // 2, HEIGHT // 4)
...
def show_end_screen(message):
    ...
    draw_text("Нажмите любую клавишу для выхода", pygame.font.Font(None, 36), WHITE, screen, WIDTH // 2, HEIGHT // 2)
    pygame.display.flip()
    waiting = True
    while waiting:
        clock.tick(FPS)
...
while running:
    ...
    # Движение мячика и проверка столкновений
    ball.move()
